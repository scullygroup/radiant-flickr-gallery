module FlickrJavascriptHelper
  ...
  def get_photosets
    ...
    @doc.xpath("/rsp/photosets/photoset").each do |node|
      ...
      flickr_photosets.push("<a class=\"#{a_class}\" href=\"/photo-gallery/#{node['id']}\"><img src=\"#{set_photo}\" /><span>#{title.text}</span></a>")
